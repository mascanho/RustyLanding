...
const Collaboration = () => {
  return (
    <Section crosses id="follow">
      <div className="container lg:flex">
        <div className="max-w-[25rem]">
          <h2 className="h2 mb-4 md:mb-8">Full Stack Marketing Integrations</h2>
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-4">
          ...
          <div className="relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100">
            ...
            <ul className="w-full h-full absolute top-0 left-0 animate-spin-slow">
              {collabApps.map((app, index) => (
                ...
                >
                  ...
                  >
                    <div className="w-full h-full animate-spin-reverse-slow flex items-center justify-center">
                      <img
                        className="m-auto"
                        width={app.width}
                        height={app.height}
