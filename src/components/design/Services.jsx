...
export const Gradient = () => {
  return (
    <div className="absolute top-0 -left-[10rem] w-[56.625rem] h-[56.625rem] opacity-50 mix-blend-color-dodge pointer-events-none lg:block hidden">
      <img
...
export const PhotoChatMessage = () => {
  return (
    <div className="absolute top-8 right-8 max-w-[17.5rem] py-6 px-8 bg-black rounded-t-xl rounded-bl-xl font-code text-base lg:top-16 lg:right-[8.75rem] lg:max-w-[17.5rem]">
      Your website&apos;s performance report is ready, sir.
...
export const RobotMessage = () => {
  return (
    <div className="absolute top-8 left-8 max-w-[17.5rem] py-6 px-8 bg-black rounded-t-xl rounded-bl-xl font-code text-base lg:top-16 lg:right-[8.75rem] lg:max-w-[17.5rem]">
      Your SEO needs improvements, no page schema was found. Let me generate
      some.
      <ChatBubbleWing className="absolute left-full bottom-0" />
    </div>
  );
