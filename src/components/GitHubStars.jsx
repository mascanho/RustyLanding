...
const GitHubStars = () => {
  ...
  return (
    <a
      ...
      className="flex items-center space-x-2 text-sm text-white/40 hover:text-yellow-400 transition-colors group"
    >
      <svg 
      ...
      {error && <span className="text-xs text-yellow-400 ml-1">(cached)</span>}
    </a>
  );
};
